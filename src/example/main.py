...
from src.example.configuration.tg_handlers import get_commands, get_handlers
from src.example.configuration.web import routes
from src.example.scenarios.away_scenarios import away_actions
from src.example.scenarios.climate_scenarios import dry_actions, water_level_checker, wc_hydro_actions
from src.example.scenarios.color_scenes_scenarios import button_actions, button_sleep_actions, random_colors_actions
from src.example.scenarios.dayly_lights_scenarios import (
...
from src.example.scenarios.motion_light_scenarios import (
