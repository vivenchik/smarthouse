...
class DeviceSet(metaclass=Singleton):
    def init(self):
        ...
        self.lamp_g_1 = HSVLamp(config.lamp_g_1_id, "Лампа гостиная 1", human_time_func=adaptive_human_time_func)
        self.lamp_g_2 = HSVLamp(config.lamp_g_2_id, "Лампа гостиная 2", human_time_func=adaptive_human_time_func)
        self.lamp_g_3 = HSVLamp(config.lamp_g_3_id, "Лампа гостиная 3", human_time_func=adaptive_human_time_func)
        self.lamp_g_4 = HSVLamp(config.lamp_g_4_id, "Лампа гостиная 4", human_time_func=adaptive_human_time_func)
